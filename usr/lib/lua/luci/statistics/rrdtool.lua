...
function Graph.__init__( self, timespan, opts )
	...
	opts.rrdpath   = opts.rrdpath   or sections.collectd_rrdtool.DataDir or rootfs .. "/tmp/rrd"
	opts.imgpath   = opts.imgpath   or sections.rrdtool.image_path       or rootfs .. "/tmp/rrdimg"
